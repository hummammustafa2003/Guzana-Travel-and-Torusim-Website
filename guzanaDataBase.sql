...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2025 at 08:48 AM
...
-- Database: `guzanadata`
--
CREATE DATABASE IF NOT EXISTS `guzanadata` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `guzanadata`;
...
INSERT INTO `registration` (`ID`, `Username`, `Password`, `DOB`, `POFB`, `Mobile`, `Profession`, `Notes`) VALUES
(1, 'hummam', '123', '1984-02-06', 'Jeddah - Saudi Arabia', '0982215651', 'programmer', 'Very Busy');
...
--
-- Table structure for table `11pma__bookmark`
--

CREATE TABLE `11pma__bookmark` (
...
('root', '[{\"db\":\"guzanadata\",\"table\":\"registration\"},{\"db\":\"guzanadata\",\"table\":\"111registration\"},{\"db\":\"guzanadata\",\"table\":\"Registration\"}]');
...
('root', '2025-10-24 06:48:02', '{\"Console\\/Mode\":\"collapse\"}');
